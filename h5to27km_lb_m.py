...
def getdata(year, month, day):
    #打开hrrr文件
    with h5py.File('/mnt/nfs/samba/数据聚变/气象数据/hrrr区域划分实验数据/hrrr_440_24var_lb_mountain/hrrr_nwp_h5/2022/'+month+'/'+day+'.h5') as d1:
        d1 = d1['fields'][:]
    ...
    #存下来
        ...
        hdf5_path = '/mnt/nfs/samba/数据聚变/气象数据/hrrr区域划分实验数据/hrrr_440_24var_lb_mountain/hrrr_nwp_h5_110/' + month
